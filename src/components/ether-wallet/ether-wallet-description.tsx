    ...
    <div className={'pf-project-text'}>
      <FadeReveal>
        ...
        <p>
          ...
          The backend was built with <a href={'https://nodejs.org'} target={'_blank'}>Node.JS</a> and <a href={'https://firebase.google.com/products/storage'} target={'_blank'}>Firebase Cloud Firestore</a> for storing
